...
const supportChannels: SupportChannel[] = [
  {
    ...
    description:
      "Chat with the Theo team and community in real time. The fastest way to get help, share feedback, and stay up to date.",
    icon: MessageCircle,
  ...
  },
  {
    ...
    icon: Mail,
    href: "mailto:support@theo.example",
    cta: "support@theo.example",
  },
  {
    title: "Read the docs",
    description:
  ...
  },
  {
    ...
    description:
      "Found a bug or want to request a feature? Theo is open source, so you can open an issue directly on GitHub.",
    icon: Github,
    href: "https://github.com/imeaysin/theo/issues",
    cta: "Open an issue",
    isExternal: true,
  },
]
...
const quickLinks = [
  ...
  { label: "Download Theo", href: "/download" },
]
        ...
        <div className="mx-auto max-w-3xl pt-16 pb-24 md:pt-24 md:pb-32">
          <div className="mb-16 text-center md:mb-20">
            ...
            <p className="mx-auto max-w-2xl text-lg leading-relaxed text-muted-foreground md:text-xl">
              ...
              here&apos;s how to reach the Theo team and community.
            </p>
          </div>
