...
export const freeScreenRecorderContent = {
  ...
  featuresTitle: "Why Choose Theo's Free Screen Recorder?",
  featuresDescription:
    "Theo provides all the tools you need for powerful, no-cost screen recording",
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Designed for ease of use, Theo makes it simple to record your screen in just a few clicks.",
    },
    {
  ...
  useCasesTitle: "Popular Uses for Theo's Free Screen Recorder",
  useCasesDescription:
    "Explore how Theo can support your recording needs, all at no cost",
  ...
  faqs: [
    {
      question: "Is Theo really free?",
      answer:
        "Yes, Theo is completely free, with no hidden fees. You get access to professional-grade <a href='/screen-recorder'>screen recording</a> tools without a subscription.",
    },
    {
      question: "How long can I record for on the free plan?",
      answer:
        "Theo's free plan allows for unlimited recording time, so you can capture your screen without interruptions. Whether you're on <a href='/screen-recorder-mac'>Mac</a> or <a href='/screen-recorder-windows'>Windows</a>, there are no time limits.",
    },
    {
      question: "Can I store my recordings in the cloud?",
      answer:
        "Yes, from just $6/month, Theo offers unlimited cloud storage, making it easy to access and share recordings whenever needed.",
    },
    {
      question: "What makes Theo's free screen recorder different?",
      answer:
        "Theo offers advanced features for free, such as high-quality video capture, easy sharing options, and an intuitive interface, making it ideal for professional use without any cost.",
    },
    {
      question: "Do I need an account to use Theo's free screen recorder?",
      answer:
        "Yes, creating a free account allows you to access Theo 100% free locally.",
    },
  ],

  video: {
    url: "/videos/theo-free-screen-recorder-demo.mp4",
    thumbnail: "/videos/theo-free-screen-recorder-thumbnail.png",
    alt: "Theo free screen recorder demo showing high-quality features",
  },

  cta: {
    title: "Get Started with Theo – Your Free, High-Quality Screen Recorder",
