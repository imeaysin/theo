...
export const webmToMp4Content: ToolPageContent = {
  ...
  cta: {
    ...
    description:
      "Theo is a free open-source screen recorder with editing, GIFs, and annotations.",
...
export const trimVideoContent: ToolPageContent = {
  ...
  cta: {
    ...
    description:
      "Theo is lightweight, powerful, and cross-platform. Record and share securely in seconds with custom S3 bucket support..",
    buttonText: "Download Theo Free",
  },

  featuresTitle: "Why Use Theo's Online Video Trimmer?",
  featuresDescription:
