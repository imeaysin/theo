...
const features: Feature[] = [
  ...
  },
  {
    icon: faGlobe,
    title: "Custom Domain",
    description: "Share recordings from your own domain (theo.yourdomain.com)",
    category: "sharing",
    isPro: true,
  },
  {
  ...
  },
  {
    icon: faInfinity,
    title: "No Watermarks",
    description: "Your recordings are yours - no Theo watermarks ever",
    category: "editing",
  },
  ...
  },
  {
    ...
    title: "Webhooks & API",
    description:
      "Integrate Theo into your workflow with webhooks and API access",
    category: "platform",
    isPro: true,
    isComingSoon: true,
    size: "medium",
