...
export const metadata: Metadata = {
  title: "MP4 to MP3 Converter | Extract Audio from Video | Theo",
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Theo MP4 to MP3 Converter Tool",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://theo.example/tools/convert/mp4-to-mp3",
  },
}
...
const breadcrumbSchema = createBreadcrumbSchema([
  ...
  { name: "Convert", url: "https://theo.example/tools/convert" },
  {
    ...
    url: "https://theo.example/tools/convert/mp4-to-mp3",
  },
])
