...
export const metadata: Metadata = {
  title: "MKV to MP4 Converter | Free Online Video Converter | Theo",
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Theo MKV to MP4 Converter Tool",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://theo.example/tools/convert/mkv-to-mp4",
  },
}
...
const breadcrumbSchema = createBreadcrumbSchema([
  ...
  { name: "Convert", url: "https://theo.example/tools/convert" },
  {
    ...
    url: "https://theo.example/tools/convert/mkv-to-mp4",
  },
])
