...
export const metadata: Metadata = {
  title: "MP4 to WebM Converter | Free Online Video Converter | Theo",
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Theo MP4 to WebM Converter Tool",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://theo.example/tools/convert/mp4-to-webm",
  },
}
...
const breadcrumbSchema = createBreadcrumbSchema([
  ...
  { name: "Convert", url: "https://theo.example/tools/convert" },
  {
    ...
    url: "https://theo.example/tools/convert/mp4-to-webm",
  },
])
