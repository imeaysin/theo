...
export const metadata: Metadata = {
  title: "AVI to MP4 Converter — Free Online Video Converter | Theo",
  description:
  ...
  openGraph: {
    ...
    url: "https://theo.example/tools/convert/avi-to-mp4",
    siteName: "Theo",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Theo AVI to MP4 Converter — Free Online Video Converter",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://theo.example/tools/convert/avi-to-mp4",
  },
}
...
const faqs = [
  {
    ...
    answer:
      "Open Theo's AVI to MP4 converter, drag and drop your AVI file (or click to browse), then click Convert. The entire process runs in your browser — your file never leaves your device. Once complete, click Download to save the MP4 file.",
  },
  {
...
const howToSteps = [
  {
    ...
    text: "Open Theo's AVI to MP4 converter and drag and drop your AVI file into the upload area, or click to browse your files. Supports AVI files up to 500 MB.",
  },
  {
...
const howToStructuredData = {
  ...
  description:
    "Convert AVI video files to MP4 format for free using Theo's browser-based converter. No upload required.",
