...
export const metadata: Metadata = {
  title: "MP4 to GIF Converter — Free Online Animated GIF Maker | Theo",
  description:
  ...
  openGraph: {
    ...
    url: "https://theo.example/tools/convert/mp4-to-gif",
    siteName: "Theo",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Theo MP4 to GIF Converter — Free Online Animated GIF Maker",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://theo.example/tools/convert/mp4-to-gif",
  },
}
...
const faqs = [
  {
    ...
    answer:
      "Open the Theo MP4 to GIF converter, drag and drop your MP4 file (or click to browse), adjust your settings if needed, then click Convert. The entire process runs in your browser — your file never leaves your device. Once complete, download the GIF instantly.",
  },
  {
...
const howToSteps = [
  {
    ...
    text: "Open the Theo MP4 to GIF converter and drag and drop your MP4 file into the upload area, or click to browse your files.",
  },
  {
...
const howToStructuredData = {
  ...
  description:
    "Convert MP4 video files to animated GIF format for free using Theo's browser-based converter. No upload required.",
...
export default function MP4ToGIFPage() {
  const pageContent: ToolPageContent = {
    ...
    cta: {
      ...
      description:
        "Record, edit, and share video messages with Theo. 100% open source and privacy focused. Export directly to MP4 — no conversion needed.",
