...
export const metadata: Metadata = {
  title: "MOV to MP4 Converter — Free Online Video Converter | Theo",
  description:
  ...
  openGraph: {
    ...
    url: "https://theo.example/tools/convert/mov-to-mp4",
    siteName: "Theo",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Theo MOV to MP4 Converter — Free Online Video Converter",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://theo.example/tools/convert/mov-to-mp4",
  },
}
...
const faqs = [
  {
    ...
    answer:
      "Open Theo's MOV to MP4 converter, drag and drop your MOV file (or click to browse), then click Convert. The entire process runs in your browser — your file never leaves your device. Once complete, click Download to save the MP4 file.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. iPhones and iPads record video in the MOV (QuickTime) container using HEVC or H.264. Theo's converter handles both formats and outputs a widely compatible MP4 file you can share, upload, or play on any device.",
  },
  {
...
const howToSteps = [
  {
    ...
    text: "Open Theo's MOV to MP4 converter and drag and drop your MOV file into the upload area, or click to browse your files. Supports QuickTime MOV files up to 500 MB.",
  },
  {
...
const howToStructuredData = {
  ...
  description:
    "Convert Apple QuickTime MOV video files to MP4 format for free using Theo's browser-based converter. No upload required.",
