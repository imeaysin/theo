...
export const metadata: Metadata = {
  title: "WebM to MP4 Converter — Free Online Video Converter | Theo",
  description:
  ...
  openGraph: {
    ...
    url: "https://theo.example/tools/convert/webm-to-mp4",
    siteName: "Theo",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Theo WebM to MP4 Converter — Free Online Video Converter",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://theo.example/tools/convert/webm-to-mp4",
  },
}
...
const faqs = [
  {
    ...
    answer:
      "Open Theo's WebM to MP4 converter, drag and drop your WebM file (or click to browse), then click Convert. The entire process runs in your browser — your file never leaves your device. Once complete, click Download to save the MP4 file.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Browser-based screen recorders, Chrome extensions, and tools using the MediaRecorder API typically produce VP8 or VP9 WebM files. Theo's converter handles both VP8 and VP9 WebM files and outputs a universally compatible H.264 MP4.",
  },
  {
...
const howToSteps = [
  {
    ...
    text: "Open Theo's WebM to MP4 converter and drag and drop your WebM file into the upload area, or click to browse your files. Supports WebM files up to 500 MB, including VP8 and VP9 encoded files from screen recorders.",
  },
  {
...
const howToStructuredData = {
  ...
  description:
    "Convert WebM video files to MP4 format for free using Theo's browser-based converter. No upload required.",
  ...
  const pageContent: ToolPageContent = {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Most browser-based screen recorders, Chrome extensions, and MediaRecorder tools output WebM files. Theo's converter handles VP8 and VP9 WebM files and turns them into shareable MP4s.",
      },
      {
    ...
    cta: {
      ...
      description:
        "Record, edit, and share video messages with Theo. 100% open source and privacy focused. Records directly to MP4 — no conversion needed.",
