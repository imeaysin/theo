...
export const metadata: Metadata = {
  title:
    "Video Speed Controller Online – Speed Up or Slow Down Videos Free | Theo",
  description:
  ...
  openGraph: {
    ...
    url: "https://theo.example/tools/video-speed-controller",
    siteName: "Theo",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Theo Video Speed Controller — Free Online Video Speed Changer",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://theo.example/tools/video-speed-controller",
  },
}
...
const faqs = [
  {
    ...
    answer:
      "Open Theo's Video Speed Controller, drag and drop your video file (or click to browse), select your target speed from 0.25× to 3×, then click Speed Up or Slow Down Video. The entire process runs in your browser — your file never leaves your device. Once processing is complete, preview and download the result.",
  },
  {
...
const howToSteps = [
  {
    ...
    text: "Open Theo's Video Speed Controller and drag and drop your video into the upload area, or click to browse your files. Supported formats include MP4, WebM, MOV, AVI, and MKV up to 500 MB.",
  },
  {
...
const howToStructuredData = {
  ...
  description:
    "Adjust the playback speed of any video for free using Theo's browser-based speed controller. No upload required.",
...
export default function SpeedControllerPage() {
  const pageContent: ToolPageContent = {
    ...
    cta: {
      ...
      description:
        "Record, edit, and share video messages with Theo. 100% open source and privacy focused. No speed adjustments needed — just hit record.",
