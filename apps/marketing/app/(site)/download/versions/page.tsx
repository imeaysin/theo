...
export const metadata: Metadata = {
  title: "All Versions — Theo",
  description:
    "Download previous versions of Theo for macOS, Windows, and Linux.",
}
    ...
    return (
      <div className="flex flex-wrap gap-2">
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-md bg-primary px-3 py-1.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary"
        >
          <AppleIcon />
          Apple Silicon
        </a>
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-md bg-muted px-3 py-1.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted"
        >
          <AppleIcon />
          Intel
        </a>
...
function ReleaseRow({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-lg border border-border bg-muted p-4 md:flex-row md:items-center md:justify-between">
...
export default async function VersionsPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-5 py-24 sm:px-8 md:py-32">
      <div className="flex flex-col gap-6">
        ...
        {error ? (
          <div className="rounded-lg border border-destructive bg-destructive p-4 text-destructive">
            {error}
          </div>
        ) : releases.length === 0 ? (
