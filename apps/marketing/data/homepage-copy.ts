...
export const homepageCopy: HomePageCopy = {
  header: {
    ...
    variants: {
      default: {
        ...
        description:
          "Theo is the only screen recording tool you need — three modes in one app that replace your recorder, editor, screenshot tool, and video host. Fully open source, and you can connect your own Google Drive or S3 bucket, so you own every recording.",
      },
    },
    modes: [
      {
    ...
    cta: {
      primaryButton: "Upgrade to Theo Pro",
    ...
    features: [
      {
        ...
        description:
          "Connect your own Google Drive or S3 bucket, use Theo Cloud, or keep everything local. You're never locked into our infrastructure, perfect for teams with compliance requirements or anyone who values data sovereignty.",
      },
      {
      ...
      },
      {
        ...
        description:
          "See exactly how Theo works, contribute features you need, or self-host for complete control. Join a community of builders who believe great tools should be transparent, extensible, and respect their users.",
      },
      {
        title: "Speed Up Your Workflow With Theo AI",
        description:
      ...
      },
      {
        ...
        description:
          "Switching from Loom? Import your existing recordings directly into Theo with our built-in importer. Keep all your content in one place without starting from scratch.",
      },
    ],
  },
  bento: {
    ...
    cards: [
      {
        ...
        description:
          "Plug in your own Google Drive or S3 bucket, route to Theo Cloud, or keep recordings entirely local. Your videos, your storage, your bill, with no vendor lock-in, ever.",
      },
      {
        key: "ai",
  ...
  testimonials: {
    ...
    subtitle:
      "Join thousands who've made Theo their daily driver for visual communication.",
  ...
  pricing: {
    ...
    commercial: {
      ...
      description:
        "A commercial license for the Theo desktop app — unlimited local recording and editing.",
      features: [
    ...
    pro: {
      ...
      features: [
        ...
        "Custom domain (theo.yourdomain.com)",
  ...
  faq: {
    ...
    items: [
      {
        question:
          "What is the difference between Theo Pro and Desktop License?",
        answer:
          "Theo Pro is a paid plan that includes all the features of the Desktop License plus cloud features for seamless sharing and collaboration. Desktop License grants you commercial usage rights for a single user.",
      },
      {
        question: "Is there a free version?",
        answer:
          "Yes! Theo is 100% free for personal use. You can record and share locally with Studio Mode. A paid plan is required for commercial usage.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes! Theo Pro includes team workspaces where you can organize recordings, manage permissions, and collaborate. Volume discounts available for teams over 10 users. Contact us for custom enterprise features.",
      },
      {
      ...
      {
        question: "Can I use Theo for commercial purposes?",
        answer:
          "Absolutely! Any paid plan (Desktop License or Theo Pro) includes full commercial usage rights. Use Theo for client work, sell courses, or embed recordings anywhere. The free version is for personal use only.",
      },
      {
        question: "Is my data secure?",
        answer:
          "Security is core to Theo. As an open source project, our code is fully auditable and transparent — you can see exactly how your data is handled. End-to-end encryption for cloud storage, option to use your own infrastructure, and community-driven security reviews keep your content safe.",
      },
      {
        question: "What about GDPR/HIPAA compliance?",
        answer:
          "Theo Pro lets you bring your own storage, including custom S3 buckets in any region or your own Google Drive, for GDPR compliance. For HIPAA and other regulations, our self-hosted option gives you complete control. We also offer signed BAAs for enterprise customers.",
      },
    ],
  },
  readyToGetStarted: {
