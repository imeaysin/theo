...
Comments let viewers leave feedback directly on your Theo recordings. Every comment is tied to a specific timestamp in the video, making it easy to have precise, contextual conversations about what is on screen.
...
1. Open the shared Theo link in your browser.
...
- **On your dashboard** - Your [Theo dashboard](https://theo.example/dashboard) shows notifications for new comments on your recordings.
...
- **In-app notifications** - Visible on your Theo dashboard.
...
Record yourself walking through a pull request, share the Theo link in the PR, and let reviewers leave timestamped comments pointing out specific lines or patterns they want to discuss.
