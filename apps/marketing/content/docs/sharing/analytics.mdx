...
Theo provides analytics for your shared recordings so you can understand who is viewing your content and how your recordings are performing over time. Analytics are available on your Theo dashboard for every recording you have shared.
...
Unique views are tracked using anonymous session identifiers. Theo does not collect personally identifiable information about viewers unless they are signed in with a Theo account.

## Dashboard Overview

Your Theo dashboard provides a high-level view of all your recordings with key metrics visible at a glance:
...
For team standups and updates shared via Theo, analytics confirm whether your teammates are actually watching. If view counts are low, consider adjusting your sharing approach or recording format.
...
Theo prioritizes viewer privacy. Analytics show aggregate data like view counts and unique view counts. Individual viewer identification is not provided for general share links.
