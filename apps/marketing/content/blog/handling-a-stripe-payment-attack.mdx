...
description: How we handled an unexpected Stripe payment attack during Theo's Product Hunt launch, and what we learnt from it.
...
A couple of days ago, we launched Theo on Product Hunt, confident we were prepared for anything.
