export const recordScreenWindowsContent = {
  ...
  description:
    "Learn how to record your screen with crisp internal audio on Windows 11—without Stereo Mix. Capture mic + system sound together using Theo. Step-by-step setup, fixes, and FAQs.",
  publishedAt: "2025-09-17",
  category: "Tutorials",
  author: "Theo Team",
  tags: ["Screen Recording", "Windows", "System Audio", "Tutorials"],
  gradientColors: ["var(--muted)", "var(--accent)", "var(--primary)"],

  heroTLDR:
    "You don't need the old Stereo Mix device. Theo uses modern WASAPI loopback capture to record exactly what's playing through your speakers or headphones, plus your microphone, in just a couple of clicks.",
  ...
  methods: [
    {
      title: "Method 1: Theo (Fastest Path)",
      description:
        "Theo makes it simple to record your Windows screen with system audio using modern WASAPI loopback:",
      steps: [
        {
          title: "Step 1: Install Theo",
          content:
            'Download and install Theo from <a href="/download">Theo.so/download</a>.',
        },
        {
        ...
        },
        {
          ...
          content: `
            <ol>
              <li>Open Theo and choose your recording mode (Instant or Studio)</li>
            ...
            <p><strong>Pro Tip:</strong> Theo captures both audio sources on separate tracks so you can adjust levels independently in the editor.</p>
          `,
        },
      ],
    },
      ...
      steps: [
        {
          content: `
            ...
            <p><strong>Use Theo instead</strong> for better control and desktop recording capabilities.</p>
          `,
        },
      ],
    },
  ...
  troubleshooting: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Double-check the Volume mixer settings and confirm the app is playing to the output device Theo is monitoring. Theo captures from your default output device using WASAPI loopback.",
      },
      {
        question: "Can't find Stereo Mix on Windows 11",
        answer:
          "Many modern devices hide Stereo Mix or don't include it. You don't need it—Theo uses WASAPI loopback to record internal audio directly from your default output device.",
      },
    ],
  },
    ...
    tips: [
      {
        ...
        description:
          "Theo records system audio and microphone on separate tracks, allowing you to adjust levels independently in the editor.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Theo can automatically generate captions for your recording, making content more accessible.",
      },
      {
  ...
  faqs: [
    {
      ...
      answer:
        "Yes, absolutely. In Theo, enable both 'System Audio' and 'Microphone' in the recording options. Theo captures both on separate tracks so you can adjust levels independently in the editor.",
    },
    {
      question: "Why can't I find Stereo Mix on Windows 11?",
      answer:
        "Many modern devices hide Stereo Mix or don't include it at all in their drivers. The good news is you don't actually need it anymore. Theo uses WASAPI loopback to record internal audio directly from your default output device.",
    },
    {
      question: "Does Game Bar record everything on the desktop?",
      answer:
        "Not really. Game Bar is optimized for recording games and specific application windows, not general desktop activities or File Explorer workflows. For tutorial creation or full-desktop walkthroughs, dedicated tools like Theo give you much more control and better results.",
    },
    {
      question: "Will this work on older Windows versions?",
      answer:
        "Theo's WASAPI loopback capture works on Windows 10 and Windows 11. It's more reliable than the old Stereo Mix method across different hardware configurations.",
    },
    {
  ...
  cta: {
    ...
    description:
      "Theo makes recording your Windows screen with system audio incredibly simple. No Stereo Mix required, no complex audio routing.",
    buttonText: "Download Theo",
    buttonLink: "/download",
    subtitle:
      "Download Theo for Windows – free forever • Open-source • 14-day Pro trial",
  },
