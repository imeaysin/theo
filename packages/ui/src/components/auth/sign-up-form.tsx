    ...
    <Card className={cn("w-full max-w-sm sm:max-w-md", className)} {...props}>
      <CardHeader className="text-center">
        ...
        {signInHref && (
          <CardDescription>
            ...
            <a href={signInHref} className="font-medium text-foreground hover:underline">
              Sign in
            </a>
          </CardDescription>
        )}
      ...
      <CardPanel>
        <Form onSubmit={handleSubmit} className="flex w-full flex-col gap-6">
          ...
          {onSocialSignUp && (
            <>
              <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:-mx-0 after:block after:-translate-y-1/2 after:border-t after:border-border">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <Button variant="outline" type="button" onClick={() => onSocialSignUp("apple")} disabled={isPending}>
                ...
                <Button variant="outline" type="button" onClick={() => onSocialSignUp("google")} disabled={isPending}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="mr-2 size-4">
